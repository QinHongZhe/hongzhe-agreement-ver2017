...
public class VerticalOffset {
  ...
  public static VerticalOffset per_decode(boolean align, InputStream in) throws IOException {
    return (VerticalOffset)TYPE.decode(in, (byte) (align ? 4 : 3), CONV);
  }
  
  public static final AsnType TYPE = RSI.type(131092);
  
  public static final ChoiceConverter CONV = new AnnotationChoiceConverter(VerticalOffset.class);
