...
public class DefAcceleration extends AsnModule {
  public static final DefAcceleration instance = new DefAcceleration();
  
  private DefAcceleration() {
    super(DefAcceleration.class);
  }
