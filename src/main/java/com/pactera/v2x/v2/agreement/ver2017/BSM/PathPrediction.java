...
public class PathPrediction {
  ...
  public static PathPrediction per_decode(boolean align, InputStream in) throws IOException {
    return (PathPrediction)TYPE.decode(in, (byte) (align ? 4 : 3), CONV);
  }
  
  public static final AsnType TYPE = BSM.type(655435);
  
  public static final CompositeConverter CONV = new AnnotationCompositeConverter(PathPrediction.class);
