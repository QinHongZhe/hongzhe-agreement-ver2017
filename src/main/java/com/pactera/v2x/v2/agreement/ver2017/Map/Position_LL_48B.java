...
public class Position_LL_48B {
  ...
  public static Position_LL_48B per_decode(boolean align, InputStream in) throws IOException {
    return (Position_LL_48B)TYPE.decode(in, (byte) (align ? 4 : 3), CONV);
  }
  
  public static final AsnType TYPE = Map.type(655394);
  
  public static final CompositeConverter CONV = new AnnotationCompositeConverter(Position_LL_48B.class);
