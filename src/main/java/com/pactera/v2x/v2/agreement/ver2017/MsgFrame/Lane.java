...
public class Lane {
  ...
  public static final AsnType TYPE = MsgFrame.type(1114212);
  ...
  static {
    ...
    CONV.setComponentConverters(new AsnConverter[] { laneIDConverter, (AsnConverter)compositeConverter, maneuversConverter, connectsToConverter, speedLimitsConverter, pointsConverter });
  }
}
