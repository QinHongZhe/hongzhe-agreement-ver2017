...
public class RegulatorySpeedLimit {
  ...
  public static RegulatorySpeedLimit per_decode(boolean align, InputStream in) throws IOException {
    return (RegulatorySpeedLimit)TYPE.decode(in, (byte) (align ? 4 : 3), CONV);
  }
  
  public static final AsnType TYPE = Map.type(393232);
  
  public static final CompositeConverter CONV = new AnnotationCompositeConverter(RegulatorySpeedLimit.class);
