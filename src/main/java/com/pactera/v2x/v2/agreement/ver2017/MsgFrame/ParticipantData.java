...
public class ParticipantData {
  ...
  public static final AsnType TYPE = MsgFrame.type(1310839);
  ...
  static {
    ...
    CONV.setComponentConverters(new AsnConverter[] {
          ptcTypeConverter, (AsnConverter)integerConverter, sourceConverter, (AsnConverter)octetStringConverter1, (AsnConverter)octetStringConverter2, secMarkConverter, (AsnConverter)compositeConverter1, (AsnConverter)compositeConverter2, transmissionConverter, speedConverter,
          headingConverter, angleConverter, (AsnConverter)compositeConverter3, (AsnConverter)compositeConverter4, (AsnConverter)compositeConverter5, (AsnConverter)compositeConverter6 });
  }
}
