...
public class FullPositionVector {
  ...
  public static FullPositionVector per_decode(boolean align, InputStream in) throws IOException {
    return (FullPositionVector)TYPE.decode(in, (byte) (align ? 4 : 3), CONV);
  }
  
  public static final AsnType TYPE = BSM.type(655399);
  
  public static final CompositeConverter CONV = new AnnotationCompositeConverter(FullPositionVector.class);
  ...
  static {
    ...
    CONV.setComponentConverters(new AsnConverter[] {compositeConverter1, compositeConverter2, headingConverter, transmissionConverter, speedConverter, compositeConverter3, timeConfidenceConverter, compositeConverter4, compositeConverter5});
  }
}
