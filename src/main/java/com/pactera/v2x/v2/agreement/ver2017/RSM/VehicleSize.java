...
public class VehicleSize {
  ...
  public static VehicleSize per_decode(boolean align, InputStream in) throws IOException {
    return (VehicleSize)TYPE.decode(in, (byte) (align ? 4 : 3), CONV);
  }
  
  public static final AsnType TYPE = RSM.type(524332);
  
  public static final CompositeConverter CONV = new AnnotationCompositeConverter(VehicleSize.class);
