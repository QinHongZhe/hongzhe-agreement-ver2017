...
public class LaneTypeAttributes {
  ...
  public static LaneTypeAttributes per_decode(boolean align, InputStream in) throws IOException {
    return (LaneTypeAttributes)TYPE.decode(in, (byte) (align ? 4 : 3), CONV);
  }
  
  public static final AsnType TYPE = Map.type(524340);
  
  public static final ChoiceConverter CONV = new AnnotationChoiceConverter(LaneTypeAttributes.class);
