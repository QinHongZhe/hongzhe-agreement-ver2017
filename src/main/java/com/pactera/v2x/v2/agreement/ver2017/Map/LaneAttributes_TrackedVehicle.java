...
public class LaneAttributes_TrackedVehicle extends BitString {
  ...
  public static final AsnType TYPE = Map.type(524347);
  
  public static final AsnConverter CONV = new ReflectionBitStringConverter(LaneAttributes_TrackedVehicle.class);
}
