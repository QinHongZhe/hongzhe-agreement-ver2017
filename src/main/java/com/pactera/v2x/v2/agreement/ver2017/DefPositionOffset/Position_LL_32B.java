...
public class Position_LL_32B {
  ...
  public static Position_LL_32B per_decode(boolean align, InputStream in) throws IOException {
    return (Position_LL_32B)TYPE.decode(in, (byte) (align ? 4 : 3), (AsnConverter)CONV);
  }
  
  public static final AsnType TYPE = DefPositionOffset.type(65542);
  
  public static final CompositeConverter CONV = (CompositeConverter)new AnnotationCompositeConverter(Position_LL_32B.class);
