...
public class Position_LL_28B {
  ...
  public static Position_LL_28B per_decode(boolean align, InputStream in) throws IOException {
    return (Position_LL_28B)TYPE.decode(in, (byte) (align ? 4 : 3), CONV);
  }
  
  public static final AsnType TYPE = Map.type(655386);
  
  public static final CompositeConverter CONV = new AnnotationCompositeConverter(Position_LL_28B.class);
