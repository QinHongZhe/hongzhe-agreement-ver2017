...
public class BasicSafetyMessage {
  ...
  static {
    ...
    CONV.setComponentConverters(new AsnConverter[] {
          msgCntConverter, (AsnConverter)octetStringConverter1, (AsnConverter)octetStringConverter2, secMarkConverter, (AsnConverter)compositeConverter1, (AsnConverter)compositeConverter2, transmissionConverter, speedConverter, headingConverter, angleConverter,
          (AsnConverter)compositeConverter3, (AsnConverter)compositeConverter4, (AsnConverter)compositeConverter5, (AsnConverter)compositeConverter6, (AsnConverter)compositeConverter7, (AsnConverter)compositeConverter8, (AsnConverter)octetStringConverter3 });
  }
}
