...
public class PositionOffsetLL {
  ...
  public static PositionOffsetLL per_decode(boolean align, InputStream in) throws IOException {
    return (PositionOffsetLL)TYPE.decode(in, (byte) (align ? 4 : 3), CONV);
  }
  
  public static final AsnType TYPE = RSM.type(196613);
  
  public static final ChoiceConverter CONV = new AnnotationChoiceConverter(PositionOffsetLL.class);
  ...
  static {
    ...
    CONV.setAlternativeConverters(new AsnConverter[] {compositeConverter1, compositeConverter2, compositeConverter3, compositeConverter4, compositeConverter5, compositeConverter6, compositeConverter7});
  }
}
