...
public class Position3D {
  ...
  public static Position3D per_decode(boolean align, InputStream in) throws IOException {
    return (Position3D)TYPE.decode(in, (byte) (align ? 4 : 3), CONV);
  }
  
  public static final AsnType TYPE = RSM.type(262197);
  
  public static final CompositeConverter CONV = new AnnotationCompositeConverter(Position3D.class);
