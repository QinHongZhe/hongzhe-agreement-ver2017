...
public class NodeReferenceID {
  ...
  public static NodeReferenceID per_decode(boolean align, InputStream in) throws IOException {
    return (NodeReferenceID)TYPE.decode(in, (byte) (align ? 4 : 3), CONV);
  }
  
  public static final AsnType TYPE = Map.type(196614);
  
  public static final CompositeConverter CONV = new AnnotationCompositeConverter(NodeReferenceID.class);
