...
public class Position_LL_36B {
  ...
  public static Position_LL_36B per_decode(boolean align, InputStream in) throws IOException {
    return (Position_LL_36B)TYPE.decode(in, (byte) (align ? 4 : 3), CONV);
  }
  
  public static final AsnType TYPE = BSM.type(720955);
  
  public static final CompositeConverter CONV = new AnnotationCompositeConverter(Position_LL_36B.class);
