...
public class Link {
  ...
  public static final AsnType TYPE = MsgFrame.type(983129);
  ...
  static {
    ...
    CONV.setComponentConverters(new AsnConverter[] { nameConverter, (AsnConverter)compositeConverter, speedLimitsConverter, laneWidthConverter, pointsConverter, movementsConverter, lanesConverter });
  }
}
