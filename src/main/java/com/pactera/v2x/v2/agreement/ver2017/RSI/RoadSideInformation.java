...
public class RoadSideInformation {
  ...
  public static RoadSideInformation per_decode(boolean align, InputStream in) throws IOException {
    return (RoadSideInformation)TYPE.decode(in, (byte) (align ? 4 : 3), CONV);
  }
  
  public static final AsnType TYPE = RSI.type(65569);
  
  public static final CompositeConverter CONV = new AnnotationCompositeConverter(RoadSideInformation.class);
  ...
  static {
    ...
    CONV.setComponentConverters(new AsnConverter[] { msgCntConverter, timeStampConverter, octetStringConverter, integerConverter, alertTypeConverter, stringConverter, priorityConverter, compositeConverter, alertPathConverter, alertRadiusConverter });
  }
}
