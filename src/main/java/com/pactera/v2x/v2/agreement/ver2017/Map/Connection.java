...
public class Connection {
  ...
  public static Connection per_decode(boolean align, InputStream in) throws IOException {
    return (Connection)TYPE.decode(in, (byte) (align ? 4 : 3), CONV);
  }
  
  public static final AsnType TYPE = Map.type(524351);
  
  public static final CompositeConverter CONV = new AnnotationCompositeConverter(Connection.class);
  ...
  static {
    ...
    CONV.setComponentConverters(new AsnConverter[] {compositeConverter1, compositeConverter2, phaseIdConverter });
  }
}
